...
from argus.core.models import ConsoleEvent, ElementCapture, ErrorEvent, NetworkEvent, Screenshot
...
class TestScreenshots:
    def test_add_and_get(self):
        ...
        s.add_screenshot(
            Screenshot(
                data="img1", url="http://x", timestamp=1.0, viewport={"width": 100, "height": 100}, trigger="hotkey"
            )
        )
